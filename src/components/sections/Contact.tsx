            ...
            <div className="mt-12">
              ...
              <div className="flex gap-4">
                {[Facebook, Instagram, Twitter].map((Icon, idx) => (
                  <Button key={idx} variant="outline" size="icon" className="rounded-full hover:bg-accent hover:text-white hover:border-accent">
              ...
              <form className="space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="phone" placeholder="(555) 000-0000" className="bg-white" />
                  </div>
                </div>
                <div className="space-y-2">
                ...
                <div className="space-y-2">
                  ...
                  <select id="service" className="w-full h-10 px-3 py-2 bg-white border border-input rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-accent">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea id="message" placeholder="Please describe what you need help with..." className="bg-white min-h-[150px]" />
                </div>
                <Button className="w-full bg-accent hover:bg-accent/90 text-white h-14 text-lg rounded-xl">
                  Send Message
                </Button>
              </form>
            </div>
